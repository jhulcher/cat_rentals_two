...
ActiveRecord::Schema.define(version: 20151119013052) do
  ...
  create_table "permanent_cookies", force: true do |t|
  ...
  add_index "permanent_cookies", ["user_id"], name: "index_permanent_cookies_on_user_id", using: :btree
